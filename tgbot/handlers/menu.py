...
from tgbot.keyboards.catalog_kb2 import sub_menu, notsub_menu
...
async def menu_catalog(message: Message):
    if await check_sub_channel(await message.bot.get_chat_member(chat_id=CHANNEL_ID,
        ...
        await message.bot.send_message(message.from_user.id, NOTSUB_MESSAGE,
                                       reply_markup=notsub_menu)
